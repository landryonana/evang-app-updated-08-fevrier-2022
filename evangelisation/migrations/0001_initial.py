# Generated by Django 2.2.26 on 2022-01-23 18:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contacts', models.PositiveIntegerField(blank=True, default='---', error_messages={'unique': 'Le numéro de télephone existe déjà'}, help_text='Le numéro de téléphone doit avoir 09 chiffres', null=True, unique=True, verbose_name='Numéro de téléphone')),
                ('quartier_d_habitation', models.CharField(blank=True, default='---', help_text='ce champ doit avoir au moins trois caractères', max_length=200, null=True, verbose_name="Quartier d'habitation")),
                ...
                ('boss', models.ManyToManyField(blank=True, help_text='selectionner les personnes ayant évangelisés cette personne', related_name='personnes', to='evangelisation.Participant', verbose_name="Qui l'ont évangelisé ?")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='suivi', to='evangelisation.Person', verbose_name='Personne')),
            ],
        ),
        migrations.CreateModel(
            name='Site',
